// Server-only PostgreSQL client for direct OpenProject DB access.
//
// Lazy-initialized singleton Pool — kept idle when OPIRA_DATA_SOURCE is "api"
// because no DB module is required by the factory in that mode.
//
// `OPENPROJECT_DB_URL` (server-only) holds the connection string. Never
// commit this value; rotate any credential pasted in chat or screen-shared.
